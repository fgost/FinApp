...
ALTER TABLE IF EXISTS users OWNER to "user-finApp-api-java";
ALTER TABLE IF EXISTS users_preferences OWNER to "user-finApp-api-java";
ALTER TABLE IF EXISTS user_photo OWNER to "user-finApp-api-java";
