package dsw.finApp.exception;

import dsw.finApp.exception.domain.*;
import dsw.finApp.exception.errorType.GenericException;
import dsw.finApp.exception.model.response.ExceptionResponse;
import dsw.finApp.exception.response.ErrorSpec;
import dsw.finApp.exception.security.ProviderSSOException;
